export const awsConfig = {
  Auth: {
    ...
    //   redirectSignIn: `${process.env.NEXT_PUBLIC_BASE_URL}/dashboard`, // Sign-in redirect (must match Cognito Callback URL(s))
    //   redirectSignOut: `${process.env.NEXT_PUBLIC_BASE_URL}/signin`, // Sign-out redirect (must match Cognito Sign out URL(s))
    //   responseType: "code", //
    //   options: {

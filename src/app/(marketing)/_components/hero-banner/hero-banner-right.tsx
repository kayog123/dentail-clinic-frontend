...
export default function HeroBannerRight() {
  ...
  return (
    <motion.div
      ...
      className="bg-red-700  flex justify-center items-center relative"
    >
      <div className="flex flex-col w-full h-140 bg-white">
        <div className="flex  w-full h-60 bg-white">
          ...
          <div className="flex-1 h-full bg-sky-300">
            <div className="w-full h-full bg-white rounded-bl-4xl flex items-center justify-center">
              <motion.div
                className="w-16 h-16 rounded-full bg-white/90 backdrop-blur-sm border border-white/20 flex items-center justify-center shadow-xl"
        ...
        <div className="flex bg-white  h-100">
          <div className="bg-sky-300 flex-1">
          ...
          <motion.div className="flex w-full h-full bg-sky-300 rounded-br-3xl flex-5 rounded-bl-4xl"></motion.div>
        </div>
      </div>
      <Image
        src="/dentist.png"
        alt="Dr. Johnson"
        className="w-[1200px]  rounded-full object-cover absolute bottom-0"
        height={600}
        width={600}
      />
    </motion.div>
